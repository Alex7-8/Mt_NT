...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/Servicio/WebService1.asmx?disco" />
    ...
    <div id="content">
      ...
      <span>
          ...
          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="WebService1.asmx?WSDL">Service Description</a>. </p>
              ...
              <li>
                <a href="WebService1.asmx?op=Buscar_Productos">Buscar_Productos</a>
              ...
              <li>
                <a href="WebService1.asmx?op=Factura">Factura</a>
              ...
              <li>
                <a href="WebService1.asmx?op=Historial_de_Biseccion">Historial_de_Biseccion</a>
              ...
              <li>
                <a href="WebService1.asmx?op=Historial_de_Regla_Falsa">Historial_de_Regla_Falsa</a>
